...
if (isset($_POST['add_category_btn'])) {
	...
	$cate_query = "INSERT INTO `categories`(`name`, `slug`, `description`, `status`, `popular`, `image`, `meta_title`, `meta_discription`, `meta_keywords`) VALUES ('$name','$slug','$description','$status','$popular','$filename','$meta_title','$meta_description','$meta_keywords')";
...
elseif (isset($_POST['update_category_btn'])) {
	...
	$update_query = "UPDATE `categories` SET `name`='$name',`slug`='$slug',`description`='$description',`status`='$status',`popular`='$popular',`image`='$update_filename',`meta_title`='$meta_title',`meta_discription`='$meta_description',`meta_keywords`='$meta_keywords' WHERE id='$category_id' ";
...
elseif (isset($_POST['add_product_btn'])) {
	...
	if ($name != "" && $slug != "" && $description != "") {
		// code...
		$product_query = "INSERT INTO `products`(`category_id`, `name`, `slug`, `small_description`, `description`, `original_price`, `selling_price`, `image`, `qty`, `status`, `trending`, `meta_title`, `meta_keywords`, `meta_description`) VALUES ('$category_id','$name','$slug','$small_description','$description','$original_price','$selling_price','$filename','$qty','$status','$tremding','$meta_title','$meta_keywords','$meta_description')";
	...
	{
	  redirect("add-product.php", "All fields are mandotary");
	}	
}
